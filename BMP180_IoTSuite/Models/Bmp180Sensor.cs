...
namespace BMP180_IoTSuite.Models
{
    public class Bmp180Sensor : IDisposable
    {
        ...
        public async Task<byte[]> ReadUncompenstatedTemperature()
        {
        ...
        public async Task<byte[]> ReadUncompenstatedPressure(Bmp180AccuracyMode ossMode)
        {
        ...
        {
            private double _temp, _pressure, _altitude;
            private byte[] _uncompenstatedTemp, _uncompenstatedPressure;
            ...
            [DataMember]
            public byte[] UncompenstatedTemperature
            {
                get
                {
                    return _uncompenstatedTemp;
                }
                set
                {
                    if (this._uncompenstatedTemp != value)
                    {
                        this._uncompenstatedTemp = value;
                    }
                }
            }

            [DataMember]
            public byte[] UncompenstatedPressure
            {
                get
                {
                    return _uncompenstatedPressure;
                }
                set
                {
                    if (this._uncompenstatedPressure != value)
                    {
                        this._uncompenstatedPressure = value;
                    }
                }
            }
